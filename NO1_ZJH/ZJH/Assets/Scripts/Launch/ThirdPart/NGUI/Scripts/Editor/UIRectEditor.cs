...
public class UIRectEditor : Editor
{
    ...
    protected void ReEvaluateAnchorType()
    {
        ...
        if (rect.leftAnchor.tranTarget == rect.rightAnchor.tranTarget &&
            rect.leftAnchor.tranTarget == rect.bottomAnchor.tranTarget &&
            rect.leftAnchor.tranTarget == rect.topAnchor.tranTarget)
        {
    ...
    protected virtual void DrawFinalProperties()
    {
        if (NGUIEditorTools.DrawHeader("Anchors"))
        {
            ...
            SerializedObject temp = serializedObject;
    ...
    protected void DrawAnchor(int index, bool targetSelection)
    {
        ...
        if (targetSelection)
        {
            ...
            NGUIEditorTools.DrawProperty(string.Empty, tar, false);
    ...
    static public void UpdateHorizontalAnchor(UIRect r, UIRect.AnchorPoint anchor, bool resetRelative)
    {
        ...
        // Update the rect
        anchor.rect = anchor.tranTarget.GetComponent<UIRect>();
        ...
        else
        {
            ...
            if (camera != null)
            {
                Vector3[] sides = camera.GetSides(parent);
            ...
            else
            {
                ...
                Vector3 remotePos = anchor.tranTarget.position;
