...
public class UICreateWidgetWizard : EditorWindow
{
	...
	static string mButton = string.Empty;
	static string mImage0 = string.Empty;
	static string mImage1 = string.Empty;
	static string mImage2 = string.Empty;
	static string mImage3 = string.Empty;
	static string mSliderBG = string.Empty;
	static string mSliderFG = string.Empty;
	static string mSliderTB = string.Empty;
	static string mCheckBG = string.Empty;
	static string mCheck = string.Empty;
	static string mInputBG = string.Empty;
	static string mListFG = string.Empty;
	static string mListBG = string.Empty;
	static string mListHL = string.Empty;
	static string mScrollBG = string.Empty;
	static string mScrollFG = string.Empty;
	...
	static string LoadString (string field) { string s = EditorPrefs.GetString(field); return (string.IsNullOrEmpty(s)) ? string.Empty : s; }
	...
	void CreatePopup (GameObject go, bool isDropDown)
	{
		...
		if (ShouldCreate(go, NGUISettings.atlas != null && NGUISettings.ambigiousFont != null))
		{
            ...
            vTemp2.x = Mathf.Max(4f, sphl.paddingLeft);
            vTemp2.y = Mathf.Max(4f, sphl.paddingTop);
            Vector2 hlPadding = vTemp2;
            vTemp2.x = Mathf.Max(4f, spfg.paddingLeft);
            vTemp2.y = Mathf.Max(4f, spfg.paddingTop);
            Vector2 fgPadding = vTemp2;
