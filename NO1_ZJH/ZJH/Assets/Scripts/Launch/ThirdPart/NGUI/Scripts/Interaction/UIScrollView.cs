...
public class UIScrollView : MonoBehaviour
{
    ...
    /// <summary>
    /// Event callback triggered when the scroll view is moving as a result of momentum in between of onDragStarted and OnDragFinished.
    /// </summary>
    ...
    /// <summary>
    /// get the latest bounds used by the widgets.
    /// </summary>
    ...
    /// <summary>
    /// When the content reach the edge of clipboard;
    /// </summary>
    public System.Action OnTopEdge;
    public System.Action OnBottomEdge;
    public System.Action OnLeftEdge;
    public System.Action OnRightEdge;
    ...
    public bool RestrictWithinBounds(bool instant, bool horizontal, bool vertical)
    {
        ...
        if (constraint.sqrMagnitude > 1f)
        {
            ...
            if (constraint.x > 0)
            {
                if (OnRightEdge != null) OnRightEdge();
            }
            else if (constraint.x < 0)
            {
                if (OnLeftEdge != null) OnLeftEdge();
            }
            if (constraint.y > 0)
            {
                if (OnTopEdge != null) OnTopEdge();
            }
            else if (constraint.y < 0)
            {
                if (OnBottomEdge != null) OnBottomEdge();
            }
            return true;
        }
        return false;
    ...
    public virtual void MoveRelative(Vector3 relative)
    {
        ...
        //Debug.Log("Normal_Drag----" + co.ToString());
