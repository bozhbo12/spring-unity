...
[AddComponentMenu("NGUI/UI/Custom Input Field")]
public class UIInput : MonoBehaviour
{
    ...
    /// 是否是按键修改输入
    /// </summary>
    public bool isKeyModify = false;

    public delegate void KeyModifyDelegate(KeyCode keyCode);
    /// <summary>
    /// 按键修改回调
    /// </summary>
    public KeyModifyDelegate keyModifyCallback;
...
//                }
    ...
    /// executed OnSelect;
    /// </summary>
    public OnActionCallback CustomOnSelectEvent;
    public OnActionCallback CustomOnDeselectEvent;
...
//            }
    ...
    bool ProcessEvent(Event ev)
    {
        ...
        if (isKeyModify)
        {
            ...
            current = this;
            if (keyModifyCallback != null)
            {
                keyModifyCallback(ev.keyCode);
            }
            current = null;
    ...
    protected virtual void Cleanup()
    {
        ...
        if (mBlankTex)
        {
            NGUITools.DestroyNGUI(mBlankTex);
            mBlankTex = null;
        }
    }
#endif // !MOBILE
