...
#region Create
	...
	static public void AddSprite ()
	{
		...
		{
            LogSystem.LogWarning("AddSprite You must select a game object first.");
		}
	}
	...
	static public void AddLabel ()
	{
		...
		{
            LogSystem.LogWarning("AddLabel You must select a game object first.");
		}
	}
	...
	static public void AddTexture ()
	{
		...
		{
            LogSystem.LogWarning(" AddTexture You must select a game object first.");
		}
	}
	...
	static public void AddSprite2D ()
	{
        ...
        else LogSystem.LogWarning("AddSprite2D You must select a game object first.");
	}
#endif
	...
	static public void AddWidget ()
	{
		...
		{
            LogSystem.LogWarning("AddWidget You must select a game object first.");
		}
	}
...
#region Attach
	...
	static void AddIfMissing<T> () where T : Component
	{
        ...
        else LogSystem.Log("AddIfMissing You must select a game object first.");
	}
	...
	static public void AddCollider ()
	{
		...
		if (NGUIEditorTools.WillLosePrefab(go))
		{
			...
			{
                LogSystem.LogWarning("AddCollider You must select a game object first, such as your button.");
			}
		}
	}
