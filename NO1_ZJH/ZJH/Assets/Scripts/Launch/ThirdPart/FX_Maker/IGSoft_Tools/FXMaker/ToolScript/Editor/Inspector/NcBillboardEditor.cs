...
//			DrawDefaultInspector();
            ...
            m_Sel.m_bUseUICamera        = EditorGUILayout.Toggle(GetHelpContent("m_bUseUICamera")           , m_Sel.m_bUseUICamera);
            ...
            m_Sel.SpeCameraTransform    = EditorGUILayout.ObjectField("SpeCameraTransform", m_Sel.SpeCameraTransform, typeof(Transform), true) as Transform;
	...
	protected override void HelpBox(string caption)
	{
		...
		if (caption == string.Empty || caption == "Script")
			str = FXMakerTooltip.GetHsEditor_NcBillboard(string.Empty);
		base.HelpBox(str);
	}
}
