...
public class FxmFolderPopup_NcCurveAnimation : FxmFolderPopup
{
	...
	public override bool ShowPopupWindow(Object selObj, bool bSaveDialog)
	{
		...
		{
            LogSystem.LogWarning("(selObj as NcCurveAnimation) is null");
			return false;
		}
	...
	protected override void DrawBottomRect(Rect baseRect)
	{
		...
		if (m_bSaveDialog)
		{
			...
			{
				if (saveFilename.Trim() != string.Empty)
...
// 				FXMakerEffect.inst.LoadProject();
	...
	void AddObjects(string loaddir)
	{
		...
		m_CurveAniObjects	= NgAsset.GetCurvePrefabList(m_LoadDirectory, string.Empty, true, FXMakerLayout.m_nMaxPrefabListCount, out m_nObjectCount);
...
// 		ncCurveAni.CopyTo(m_CurrentCurveAnimation, false);
	...
	void SaveCurveAniToPrefabFile()
	{
		...
		{
            LogSystem.LogWarning("FxmFolderPopup_NcCurveAnimation.m_DefaultSavePrefab is null");
			return;
		}
