...
public class NcEffectBehaviour : MonoBehaviour
{
    ...
    protected virtual void OnEnable()
    {
        ...
        System.Reflection.MethodInfo method1 = type.GetMethod("Awake", flag);
        if (method1 != null)
        {
            method1.Invoke(this, null);
        }
        System.Reflection.MethodInfo method2 = type.GetMethod("Start", flag);
        if (method2 != null)
        {
            method2.Invoke(this, null);
        }

        NcTimerTool.sw = new System.Diagnostics.Stopwatch();
        NcTimerTool.sw.Start();
        NcTimerTool.timeSinceStarupInEditor = (float)NcTimerTool.sw.ElapsedMilliseconds / 1000.0f;
        NcTimerTool.timeInEditor = 0.000001f;
    ...
    {
        EditorApplication.update -= UpdateInEditor;
        if (NcTimerTool.hasEditorPlayFun == true)
        {
            EditorApplication.update -= NcTimerTool.Update;
            NcTimerTool.hasEditorPlayFun = false;
        }
    }

    private void UpdateInEditor()
    {
        if (NcTimerTool.hasEditorPlayFun == false)
        {
            EditorApplication.update += NcTimerTool.Update;
            NcTimerTool.hasEditorPlayFun = true;
        }

        System.Reflection.BindingFlags flag = System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic;
        System.Type type = this.GetType();
        System.Reflection.MethodInfo method1 = type.GetMethod("Update", flag);
        if (method1 != null)
        {
            method1.Invoke(this, null);
        }
        System.Reflection.MethodInfo method2 = type.GetMethod("LateUpdate", flag);
        if (method2 != null)
        {
            method2.Invoke(this, null);
        }
    ...
    public static float GetEngineTime()
    {
        ...
        //    return 0.000001f;
        //return Time.time;
        return NcTimerTool.GetEngineTime();
    }
    ...
    public static float GetEngineDeltaTime()
    {
        ...
        {
            return (float)NcTimerTool.deltaTimeInEditor;
        }
#else
        return Time.deltaTime;
#endif
    ...
    {
#if (UNITY_4_0 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9 || UNITY_5_3)
    ...
    {
#if (UNITY_4_0 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9 || UNITY_5_3)
        return target == null ? false : (target.activeInHierarchy && target.activeSelf);
#else
		return target == null ? false : target.active;
#endif
    }
    ...
    static Texture[] PreloadPrefab(GameObject tarObj, List<GameObject> parentPrefabList, bool bCheckDup)
    {
        if (parentPrefabList.Contains(tarObj))
        {
            if (bCheckDup)
            {
                ...
                LogSystem.LogWarning("LoadError : Recursive Prefab - " + str + tarObj.name);
                return null;	// error
            }
            else return null;
        }
