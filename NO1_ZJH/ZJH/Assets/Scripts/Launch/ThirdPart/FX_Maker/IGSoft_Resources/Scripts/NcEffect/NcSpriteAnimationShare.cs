...
public class NcSpriteAnimationShare : NcEffectAniBehaviour
{
	// Attribute ------------------------------------------------------------------------
...
// 	public		float			m_fBlueAlphaWeight			= 1;
	...
	{
		if (m_TextureType == NcSpriteAnimationShare.TEXTURE_TYPE.TileTexture)
...
//				if (m_funcStartSprite != string.Empty)
