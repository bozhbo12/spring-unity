...
/// 可变变量存储单元基类
/// </summary>
public class WideStrVar : IVar
{
    private string mValue = string.Empty;
    public WideStrVar()
    {
    }
    public WideStrVar(string value)
    {
        mValue = value;
    }
    public override byte GetVarType()
    {
        return VarStoreType.VT_WIDESTR;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public static WideStrVar CreateVar()
    {
    ...
    /// </summary>
    /// <returns></returns>
    public static WideStrVar CreateVar(string value)
    {
        WideStrVar var = mVarStores.CreateVar();
    ...
    private static void CollectVar(WideStrVar var)
    {
    ...
    /// </summary>
    private static VarHelper<WideStrVar> mVarStores = new VarHelper<WideStrVar>(20);
}