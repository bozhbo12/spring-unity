...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class AdvanceTonemapping : PEBase
    {
        ...
        public Shader tonemapper = Shader.Find("Snail/Effect/Tonemapper");
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            {
                LogSystem.LogWarning("No valid adaptive tonemapper type found!");
